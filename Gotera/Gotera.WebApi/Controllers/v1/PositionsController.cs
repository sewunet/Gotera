...
using Gotera.Application.Features.Positions.Commands.DeletePositionById;
using Gotera.Application.Features.Positions.Commands.UpdatePosition;
using Gotera.Application.Features.Positions.Queries.GetPositionById;
using Gotera.Application.Features.Positions.Queries.GetPositions;
using Gotera.WebApi.Extensions;
...
namespace Gotera.WebApi.Controllers.v1
{
    [ApiVersion("1.0")]
